...
abstract class User implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\generatedclasses\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of generatedclasses\Base\User object.
     */
     ...
     * objects.
     *
     * @param object $copyObj An object of \generatedclasses\User (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \generatedclasses\User Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
