...
use generatedclasses\User as ChildUser;
use generatedclasses\UserQuery as ChildUserQuery;
use generatedclasses\Map\UserTableMap;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \generatedclasses\Base\UserQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\generatedclasses\\User', $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(UserTableMap::COL_USERNAME, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(UserTableMap::COL_USERNAME, $keys, Criteria::IN);
