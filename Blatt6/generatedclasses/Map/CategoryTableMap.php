...
class CategoryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'generatedclasses.Map.CategoryTableMap';
     ...
     */
    public const OM_CLASS = '\\generatedclasses\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'generatedclasses.Category';
     ...
     */
    public const COL_DESCRIPTION = 'Category.description';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [CategoryTableMap::COL_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_DESCRIPTION, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_DESCRIPTION => 2, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'description' => 'DESCRIPTION',
        'category.description' => 'DESCRIPTION',
        'CategoryTableMap::COL_DESCRIPTION' => 'DESCRIPTION',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\generatedclasses\\Category');
    ...
    {
        $this->addRelation('ProductCatalogy', '\\generatedclasses\\ProductCatalogy', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(CategoryTableMap::COL_DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \generatedclasses\Category) { // it's a model object
