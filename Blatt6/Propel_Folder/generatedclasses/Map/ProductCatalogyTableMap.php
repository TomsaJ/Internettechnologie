...
namespace generatedclasses\Map;
...
class ProductCatalogyTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'generatedclasses.Map.ProductCatalogyTableMap';
     ...
     */
    public const OM_CLASS = '\\generatedclasses\\ProductCatalogy';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'generatedclasses.ProductCatalogy';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\generatedclasses\\ProductCatalogy');
        $this->setPackage('generatedclasses');
    ...
    {
        $this->addRelation('Product', '\\generatedclasses\\Product', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':product_id',
    1 => ':id',
        ...
        $this->addRelation('Category', '\\generatedclasses\\Category', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \generatedclasses\ProductCatalogy $obj A \generatedclasses\ProductCatalogy object.
     ...
     *
     * @param mixed $value A \generatedclasses\ProductCatalogy object or a primary key value.
     *
     * @return void
     */
    public static function removeInstanceFromPool($value): void
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \generatedclasses\ProductCatalogy) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \generatedclasses\ProductCatalogy object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \generatedclasses\ProductCatalogy) { // it's a model object
