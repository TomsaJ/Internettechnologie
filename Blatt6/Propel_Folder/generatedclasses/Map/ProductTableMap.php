...
class ProductTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'generatedclasses.Map.ProductTableMap';
     ...
     */
    public const OM_CLASS = '\\generatedclasses\\Product';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'generatedclasses.Product';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\generatedclasses\\Product');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \generatedclasses\Product) { // it's a model object
