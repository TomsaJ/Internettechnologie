...
use generatedclasses\Map\CategoryTableMap;
 ...
 *
 * @method     \generatedclasses\ProductCatalogyQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \generatedclasses\Base\CategoryQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\generatedclasses\\Category', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \generatedclasses\ProductCatalogy object
     *
     * @param \generatedclasses\ProductCatalogy|ObjectCollection $productCatalogy the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    ...
    {
        if ($productCatalogy instanceof \generatedclasses\ProductCatalogy) {
            $this
            ...
            throw new PropelException('filterByProductCatalogy() only accepts arguments of type \generatedclasses\ProductCatalogy or Collection');
        }
    }
     ...
     *
     * @return \generatedclasses\ProductCatalogyQuery A secondary query class using the current class as primary query
     */
    public function useProductCatalogyQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ProductCatalogy', '\generatedclasses\ProductCatalogyQuery');
    }

    /**
     * Use the ProductCatalogy relation ProductCatalogy object
     *
     * @param callable(\generatedclasses\ProductCatalogyQuery):\generatedclasses\ProductCatalogyQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \generatedclasses\ProductCatalogyQuery The inner query object of the EXISTS statement
     */
    public function useProductCatalogyExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \generatedclasses\ProductCatalogyQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \generatedclasses\ProductCatalogyQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \generatedclasses\ProductCatalogyQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \generatedclasses\ProductCatalogyQuery The inner query object of the NOT IN statement
     */
