...
abstract class Category implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\generatedclasses\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of generatedclasses\Base\Category object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\generatedclasses\\Category'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->productCatalogiesScheduledForDeletion !== null) {
                if (!$this->productCatalogiesScheduledForDeletion->isEmpty()) {
                    \generatedclasses\ProductCatalogyQuery::create()
     ...
     * objects.
     *
     * @param object $copyObj An object of \generatedclasses\Category (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \generatedclasses\Category Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initProductCatalogies(bool $overrideExisting = true): void
    {
        ...
        $this->collProductCatalogies->setModel('\generatedclasses\ProductCatalogy');
    }
        ...
        if (null === $this->collProductCatalogies || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProductCatalogies) {
                    ...
                    $collProductCatalogies->setModel('\generatedclasses\ProductCatalogy');
