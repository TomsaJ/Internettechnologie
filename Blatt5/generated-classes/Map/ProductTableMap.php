...
use generated-classes\Product;
use generated-classes\ProductQuery;
...
class ProductTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'generated-classes.Map.ProductTableMap';
     ...
     */
    public const OM_CLASS = '\\generated-classes\\Product';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'generated-classes.Product';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\generated-classes\\Product');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \generated-classes\Product) { // it's a model object
