...
use generated-classes\ProductCatalogy;
use generated-classes\ProductCatalogyQuery;
...
class ProductCatalogyTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'generated-classes.Map.ProductCatalogyTableMap';
     ...
     */
    public const OM_CLASS = '\\generated-classes\\ProductCatalogy';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'generated-classes.ProductCatalogy';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\generated-classes\\ProductCatalogy');
    ...
    {
        $this->addRelation('Product', '\\generated-classes\\Product', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':product_id',
    1 => ':id',
        ...
        $this->addRelation('Category', '\\generated-classes\\Category', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \generated-classes\ProductCatalogy $obj A \generated-classes\ProductCatalogy object.
     ...
     *
     * @param mixed $value A \generated-classes\ProductCatalogy object or a primary key value.
     *
     * @return void
     */
    public static function removeInstanceFromPool($value): void
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \generated-classes\ProductCatalogy) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \generated-classes\ProductCatalogy object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \generated-classes\ProductCatalogy) { // it's a model object
