...
abstract class Product implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\generatedclasses\\Map\\ProductTableMap';
    ...
    /**
     * Initializes internal state of generatedclasses\Base\Product object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\generatedclasses\\Product'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \generatedclasses\Product (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \generatedclasses\Product Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
