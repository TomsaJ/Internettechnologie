...
class UserTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'blatt5.Map.UserTableMap';
     ...
     */
    public const OM_CLASS = '\\blatt5\\User';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'blatt5.User';
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \blatt5\User) { // it's a model object
