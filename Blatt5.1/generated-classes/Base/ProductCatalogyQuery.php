...
use \ProductCatalogy as ChildProductCatalogy;
 ...
 *
 * @method     \ProductQuery|\CategoryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ProductCatalogyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ProductCatalogyQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ProductCatalogy', $modelAlias = null)
    {
     ...
     * Use the Product relation Product object
     *
     * @param callable(\ProductQuery):\ProductQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \ProductQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \ProductQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \ProductQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \ProductQuery The inner query object of the NOT IN statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \CategoryQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \CategoryQuery The inner query object of the NOT IN statement
     */
