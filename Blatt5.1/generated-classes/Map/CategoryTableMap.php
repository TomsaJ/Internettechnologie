...
class CategoryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.CategoryTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'Category';
    ...
    {
        $this->addRelation('ProductCatalogy', '\\ProductCatalogy', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
