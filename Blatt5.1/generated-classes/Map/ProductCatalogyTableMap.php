...
class ProductCatalogyTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ProductCatalogyTableMap';
     ...
     */
    public const OM_CLASS = '\\ProductCatalogy';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ProductCatalogy';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\ProductCatalogy');
        $this->setPackage('');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \ProductCatalogy $obj A \ProductCatalogy object.
     ...
     *
     * @param mixed $value A \ProductCatalogy object or a primary key value.
     *
     * @return void
     */
    public static function removeInstanceFromPool($value): void
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ProductCatalogy) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ProductCatalogy object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ProductCatalogy) { // it's a model object
